...
import { createPost, deletePost, getAllPosts, getPost, getPostBySLug, updatePost } from "../controllers/postControllers.js";
...
router.get("/", verifyAccesssToken, apiRateLimitMiddleware, getAllPosts)
