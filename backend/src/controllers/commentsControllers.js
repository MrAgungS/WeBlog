...
export const createComments = async (req, res) => {
    try {
        ...
        console.error("Created commmet error: ");
...
export const getComments = async (req, res) => {
    try {
        ...
        return response(201,"Get Comment by Post success", comment, res)
    } catch (error) {
        console.error("Get commmet by post error: ");
...
export const deleteComments = async (req, res) => {
    try {
        ...
        return response(201,"Success delete comments", result, res)
    } catch (error) {
        console.error("Delete commmet error: ");
